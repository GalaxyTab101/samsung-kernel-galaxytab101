...
static DEVICE_ATTR(emmc_checksum_done, S_IRUGO | S_IWUGO, emmc_checksum_done_show, emmc_checksum_done_store);
...
static DEVICE_ATTR(emmc_checksum_pass, S_IRUGO | S_IWUGO, emmc_checksum_pass_show, emmc_checksum_pass_store);
