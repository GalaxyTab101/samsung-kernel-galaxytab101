...
/* exp	{YES,	GPIO_CAM_FLASH_EN,		GPIO_OUTPUT,	GPIO_LEVEL_LOW,			GPIO_HWREV_NONE  },*/
	...
	{NO,	GPIO_PDA_ACTIVE,		GPIO_OUTPUT,	GPIO_LEVEL_LOW,			GPIO_HWREV_NONE  },
...
//	{NO,	GPIO_MHL_I2C_SDA,		GPIO_OUTPUT,	GPIO_I2C_SDA_GROUP_SLEEP_LEVEL,	GPIO_HWREV_NONE  },
...
/*	{NO,	GPIO_HW_REV0,			GPIO_OUTPUT,	GPIO_LEVEL_LOW,			GPIO_HWREV_NONE  },		*/
	...
	{YES,	GPIO_PDA_ACTIVE,		GPIO_OUTPUT,	GPIO_LEVEL_LOW,			GPIO_HWREV_NONE  },	/* PDA ACTIVE */
...
/*	{GPIO,	GPIO_CAM_PMIC_EN2,		GPIO_OUTPUT,	GPIO_LEVEL_NONE,	GPIO_HWREV_NONE },	*/
	{GPIO,	GPIO_CAM_PMIC_SDA,		GPIO_OUTPUT,	GPIO_LEVEL_NONE,	GPIO_HWREV_NONE },	//ykh
	{GPIO,	GPIO_CAM_PMIC_SCL,		GPIO_OUTPUT,	GPIO_LEVEL_NONE,	GPIO_HWREV_NONE },	//ykh
...
//	{GPIO,	TEGRA_GPIO_PZ5,			GPIO_OUTPUT,	GPIO_LEVEL_LOW,		GPIO_HWREV_NONE  },
	...
	{GPIO,	TEGRA_GPIO_PH1,		GPIO_OUTPUT,	GPIO_LEVEL_NONE,	GPIO_HWREV_NONE },
	{GPIO,	TEGRA_GPIO_PH2,		GPIO_OUTPUT,	GPIO_LEVEL_NONE,	GPIO_HWREV_NONE },
/*	{GPIO,	TEGRA_GPIO_PI4,			GPIO_OUTPUT,	GPIO_LEVEL_LOW,		GPIO_HWREV_NONE  },*/
	...
	{SPIO,	TEGRA_GPIO_PB4,			GPIO_OUTPUT,	GPIO_LEVEL_NONE,	GPIO_HWREV_NONE },	// MOTOR_PWM
};
